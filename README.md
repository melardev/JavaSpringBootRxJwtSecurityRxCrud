...
# Introduction
An API sample showing how to create a basic Jwt secured Rest API and implement the CRUD operations with Pagination
using Spring Reactive Data repositories.
...
### Server side implementations
- [Spring Boot + Web Reactive](https://github.com/melardev/JavaSpringBootRxJwtSecurityRxCrud)
